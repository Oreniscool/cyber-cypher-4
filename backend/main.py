...
def start_recording():
    """
    Start recording audio from the microphone using PyAudio.
    """
...
def stop_recording_api():
    """
    API endpoint to stop recording and process the audio.
    """
    global recording
    recording = False
...
def process():
    """
    Transcribe, translate, and convert speech to text.
    """
    try:
